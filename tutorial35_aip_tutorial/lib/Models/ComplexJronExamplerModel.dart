...
class ComplexJronExamplerModel {
  ComplexJronExamplerModel({
      bool? success, 
      String? message, 
      List<Data>? data,}){
    _success = success;
  ...
  ComplexJronExamplerModel.fromJson(dynamic json) {
  ...
  String? _message;
  List<Data>? _data;
ComplexJronExamplerModel copyWith({  bool? success,
  String? message,
  List<Data>? data,
}) => ComplexJronExamplerModel(  success: success ?? _success,
